 ...
 *
 * @param <T> parameter for retry operation (function)
 * @param <R> return type of retry operation (function)
 * @author Lubos Krnac
 */
public class FunctionRetryHandler<T, R> {
     ...
     * @param parameter parameter to pass into method
     * @param timeout   timeout of retry loop
